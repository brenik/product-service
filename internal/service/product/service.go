...
// category_service "github.com/brenik/category-service/pkg/category-service"
var ErrWrongCategory = errors.New("category does not exist")

//go:generate mockgen -package=product_service -destination=service_mocks_test.go -self_package=github.com/brenik/product-service/internal/service/product . IRepository,ICategoryClient
